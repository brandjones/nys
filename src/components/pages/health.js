...
import { getHealthData } from "../../actions/times";
...
class Health extends React.Component {
  ...
  async componentDidMount() {
    const health = await this.props.dispatch(getHealthData());
  }

  HealthData = () => {
    return this.props.times.health.map((item, index) => {
      let url;
